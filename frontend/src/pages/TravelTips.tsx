...
const packingLists: Record<string, TravelTip> = {
    trekking: {
...
const locationTips: LocationTips[] = [
    {
...
const TravelTipsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
                                ...
                                {expandedLocation === location.location && (
                                    <div className="px-6 py-4 border-t border-green-100">
                                        ...
                                        <p className="text-gray-600">
                                            <span className="font-semibold text-green-600">Best Time to Visit:</span>{' '}
                                            {location.bestTime}
                                        </p>
                                    </div>
                                )}
            ...
            {/* Footer */}
            {/* <footer className="bg-brand-green text-white py-6 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p>Stay safe and enjoy your adventures!</p>
        </div>
      </footer> */}
