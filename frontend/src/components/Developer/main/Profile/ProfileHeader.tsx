...
const ProfileHeader = ({ isMobile, darkMode }: ProfileHeaderProps) => {
  const [profileData, setProfileData] = useState<ProfileData>({
    ...
    followersCount: 148,
    followingCount: 163,
    profilePicture: "/assets/Developers/Vishal.png",
    isVerified: false,
    highlights: [
      {
        id: "1",
    ...
    return (
      <div className="p-4 pt-8 pb-2">
        ...
        <div className="flex items-center mb-6">
          ...
          <div className="flex justify-between flex-1">
            <div className="text-center">
              <div className="font-semibold">{profileData.postsCount}</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Posts</div>
            </div>
            <div className="text-center">
              <div className="font-semibold">{profileData.followersCount}</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Followers</div>
            </div>
            <div className="text-center">
              <div className="font-semibold">{profileData.followingCount}</div>
        ...
        <div className="flex gap-2 mb-6">
          <button className="flex-1 bg-gray-200 dark:bg-gray-800 py-1.5 rounded-md font-semibold">Edit Profile</button>
          <button className="flex-1 bg-gray-200 dark:bg-gray-800 py-1.5 rounded-md font-semibold">Share Profile</button>
        </div>
