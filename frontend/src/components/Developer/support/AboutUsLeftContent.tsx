...
const AboutUsLeftContent = () => {
    return (
        <div>
            <div>
                <p className="text-[#EADED0] leading-relaxed mb-6">
                ...
                <div className="flex items-center mt-4 space-x-6">
                    <div className="text-center">
                        <h3 className="text-2xl font-bold text-[#233115]">10+</h3>
                        <p className="text-[#EADED0]">Years of Experience</p>
                    </div>
                    <div className="text-center">
                        <h3 className="text-2xl font-bold text-[#233115]">5,000+</h3>
                        <p className="text-[#EADED0]">Satisfied Clients</p>
                    </div>
                    <div className="text-center">
                        <h3 className="text-2xl font-bold text-[#233115]">100+</h3>
                        <p className="text-[#EADED0]">Location Covered</p>
                    </div>
                </div>
            </div>
        </div>
