...
export default function DestinationCarousel({ destinations }: DestinationCarouselProps) {
  ...
  }, [currentIndex]) // Re-run if `currentIndex` changes
                ...
                >
                  <Card
                    className={`
                      ...
                      ${isActive
                        ? "z-20 transform-none w-full h-[600px] opacity-100 scale-100"
                        : isPrev || isNext
                          ? "z-10 w-full h-[600px] opacity-0 scale-95 translate-x-0"
                  ...
                  >
                    <CardContent className="p-0">
                      ...
                      <div className="p-8 space-y-4 text-left">
                        ...
                        <Button
                          variant="default"
                          className="bg-[#1a1a1a] hover:bg-[#2a2a2a] text-white rounded-full px-6"
                        >
                          Read More
